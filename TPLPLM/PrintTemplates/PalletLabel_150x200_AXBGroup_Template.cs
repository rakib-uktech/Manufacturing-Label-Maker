...
public class PalletLabel_150x200_AXBGroup_Template
{
    public void Print(
        LabelInfo labelinfo,
        ...
        long labelNoBase)
    {
            ...
            for (int i = 0; i < printCount; i++)
            {
                ...
                printDoc.PrintPage += (sender, e) =>
                {
                    ...
                    if (System.IO.File.Exists(imagePath))
                    {
                        ...
                        string originLabel = "Country of Origin:";
                        string originValue = "UK";
                        ...
                        e.Graphics.DrawString(value, valueFont, Brushes.Black, new PointF(textX + labelSize.Width + 5, textY));
                    ...
                    {
                        var addressFont = new Font("Arial Narrow", 9);
                        var websiteFont = new Font("Arial Narrow", 9, FontStyle.Italic);

                        e.Graphics.DrawString(Address, new Font("Arial", 11), Brushes.Black, new PointF(x, y));
                        y += 15;
                        // Add website text just below address
                        string website = "www.slush.co.uk";
        ...
        {
            throw new Exception("AXB Pallet Label Error: " + ex.Message);
        }
    }

    // ================= BARCODE =================
    private void PrintBarcode(PrintPageEventArgs e, ref float y, float x, string data)
    {
        ...
        using var bmp = writer.Write("\u00f1" + data);
    ...
    // ================= SSCC =================
    private string CalculateSSCC(string input)
    {

...
{
    public class PalletLabel_150x200_Standard_Template
    {
        public void Print(
            LabelInfo labelinfo,
                ...
                for (int i = 0; i < printCount; i++)
                {
                    ...
                    printDoc.PrintPage += (sender, e) =>
                    {
                        ...
                        void PrintInline(string label1, string value1, string label2, string value2)
                        {
                            ...
                            float label1X = x;
                            float value1X = label1X + label1Width + padding - 2f;
                            float label2X = value1X + value1Width + padding - 2f;
                            float value2X = label2X + label2Width + padding - 2f;

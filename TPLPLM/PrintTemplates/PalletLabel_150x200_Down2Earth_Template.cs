...
{
    public class PalletLabel_150x200_Down2Earth_Template
    {
        public void Print(
            LabelInfo labelinfo,
            ...
            long labelNoBase)
        {
                ...
                for (int i = 0; i < printCount; i++)
                {
                    ...
                    printDoc.PrintPage += (sender, e) =>
                    {
                        ...
                        if (System.IO.File.Exists(imagePath))
                        {
                            ...
                            // Define X positions
                            float logoX = x;
                            float barcodeX = x + logoWidth + 150; // center-ish
                            float textX = barcodeX + barcodeSize + 30; // right side
            ...
            {
                throw new Exception(
                    "Down2Earth Pallet Label Error: " + ex.Message);
            }
        }

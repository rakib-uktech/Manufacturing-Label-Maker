...
public class CaseLabel_CC_Template
{
    public void Print(
        LabelInfo labelinfo,
        ...
        long labelNoBase)
    {
        try
        {
            ...
            for (int i = 0; i < printCount; i++)
            {
                ...
                var paperSize = new PaperSize("CC_Label", 400, 600);
                ...
                printDoc.PrintPage += (sender, e) =>
                {
                    ...
                    void PrintWrappedRow(string label, string value, float labelWidth = 100f, float maxWidth = 380f)
                    {
                        var labelFont = new Font("Arial", 10, FontStyle.Regular);
        ...
        {
            throw new Exception("CC Template Error: " + ex.Message);
        }
    }
}
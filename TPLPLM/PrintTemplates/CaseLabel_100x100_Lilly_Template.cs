...
public class CaseLabel_100x100_Lilly_Template
{
    public void Print(
        LabelInfo labelinfo,
        ...
        long labelNoBase)
    {
        try
        {
            ...
            for (int i = 0; i < printCount; i++)
            {
                ...
                printDoc.PrintPage += (sender, e) =>
                {
                    ...
                    {
                        // =========================
                        // LILLY PACKAGING HEADER
                        // =========================

                        float topY = y;

                        // Large bold title instead of logo
                        ...
                        // Measure height of title for alignment with barcode
                        SizeF titleSize;
                        using (var measureFont = new Font("Arial", 18, FontStyle.Bold))
                        {
                            titleSize = e.Graphics.MeasureString("Lilly Packaging", measureFont);
                        }
                        ...
                        // Align barcode to the right of text
                        float barcodeX = x + 220;
                        float barcodeY = topY;
                        ...
                        y = topY + Math.Max(titleSize.Height, barcodeBitmap.Height) - 20;

                    }
                    string fixedAddress = "Access Business Centre, First Way, Wembley, Middlesex, HA9 0JD";
        ...
        {
            throw new Exception("Lilly Template Error: " + ex.Message);
        }
    }
